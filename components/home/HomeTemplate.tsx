    ...
    <div className="pt-24 pb-20 px-4 max-w-[1400px] mx-auto min-h-screen relative grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)_280px] gap-8 lg:gap-10">
      ...
      <div className="hidden lg:flex flex-col gap-8">
        <div className="sticky top-24">
          ...
          {/* 公告板 */}
          {latestAnnouncement && (
            <div className="mt-8 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-2xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] dark:shadow-[0_2px_10px_-3px_rgba(0,0,0,0.3)] border border-blue-100/50 dark:border-blue-800/30">
