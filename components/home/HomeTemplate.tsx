    ...
    <div className="pt-24 pb-20 px-4 max-w-[1400px] mx-auto min-h-screen relative grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)_280px] gap-8 lg:gap-10">
      ...
      <div className="hidden lg:flex flex-col gap-8">
        <div className="sticky top-24">
          ...
          {/* 日历热力图占位 */}
          <div className="mt-8 bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
            <h3 className="text-sm font-semibold text-gray-500 mb-4 uppercase tracking-wider">活跃度</h3>
            <GithubHeatmap username={aboutData.github ? aboutData.github.split("/").pop() || "xixiyhaha" : "xixiyhaha"} />
          </div>
        </div>
      </div>
